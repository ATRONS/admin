...
const AuthorListPages = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // fetchData();
    setTotalPage(1);
    setAuthors(Authors_Dummy);
    setSelectedItems([]);
    setTotalItemCount(Authors_Dummy.length);
    setIsLoaded(true);
...
export default AuthorListPages;
