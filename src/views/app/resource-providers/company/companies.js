...
import AddNewCompany from '../../../../containers/resource-providers/AddNewCompany';
...
const companies_Dummy = [
  {
    id: 1,
    legal_name: 'Alemayehu Gelagay',
    display_name: 'Alazar Bizen',
    email: 'alaazaaro@gmail.com',
    is_company: true,
    provides: 'BOOK',
    img: 'http://localhost:3000/assets/img/products/bebinca-thumb.jpg',
    company_info: {
...
const CompanyListPages = ({ match }) => {
  ...
  useEffect(() => {
    // fetchData();
    setTotalPage(1);
    setcompanies(companies_Dummy);
    setSelectedItems([]);
    setTotalItemCount(companies_Dummy.length);
    setIsLoaded(true);
...
export default CompanyListPages;
